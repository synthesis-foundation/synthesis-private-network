// Package address contains the types used by synthesis to represent IPv6 addresses or prefixes, as well as functions for working with these types.
...
// Address represents an IPv6 address in the synthesis address range.
type Address [16]byte

// Subnet represents an IPv6 /64 subnet in the synthesis subnet range.
type Subnet [8]byte

// GetPrefix returns the address prefix used by synthesis.
