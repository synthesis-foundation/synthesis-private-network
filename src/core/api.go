...
// Address gets the IPv6 address of the Synthesis node. This is always a /128
...
// Subnet gets the routed IPv6 subnet of the Synthesis node. This is always a
...
// SetLogger sets the output logger of the Synthesis node after startup. This
