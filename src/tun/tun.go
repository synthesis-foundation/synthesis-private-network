...
// synthesis.Adapter type. In order to use the TUN adapter with Synthesis, you
// should pass this object to the synthesis.SetRouterAdapter() function before
// calling synthesis.Start().
...
// the Synthesis core before this point and it must not be in use elsewhere.
