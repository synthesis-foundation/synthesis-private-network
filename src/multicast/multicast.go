...
// by Synthesis to find peers on the same subnet. When a beacon is received on a
// configured multicast interface, Synthesis will attempt to peer with that node
// automatically.
