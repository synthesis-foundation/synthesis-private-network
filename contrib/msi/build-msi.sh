...
# This script generates an MSI file for Synthesis for a given architecture. It
...
if not exist %ALLUSERSPROFILE%\\Synthesis (
  mkdir %ALLUSERSPROFILE%\\Synthesis
)
if not exist %ALLUSERSPROFILE%\\Synthesis\\synthesis.conf (
  if exist synthesis.exe (
    synthesis.exe -genconf > %ALLUSERSPROFILE%\\Synthesis\\synthesis.conf
  )
)
EOF
...
if [ $PKGNAME != "master" ]; then
  PKGDISPLAYNAME="Synthesis Network (${PKGNAME} branch)"
else
  PKGDISPLAYNAME="Synthesis Network"
fi
...
<Wix xmlns="http://schemas.microsoft.com/wix/2006/wi">
  <Product
    ...
    Manufacturer="github.com/synthesis-network">

    <Package
      Id="*"
      Keywords="Installer"
      Description="Synthesis Network Installer"
      Comments="Synthesis Network standalone router for Windows."
      Manufacturer="github.com/synthesis-network"
    ...
    <Directory Id="TARGETDIR" Name="SourceDir">
      <Directory Id="${PKGINSTFOLDER}" Name="PFiles">
        <Directory Id="SynthesisInstallFolder" Name="Synthesis">
          ...
          <Component Id="MainExecutable" Guid="c2119231-2aa3-4962-867a-9759c87beb24">
            ...
            <ServiceInstall
              Id="ServiceInstaller"
              Account="LocalSystem"
              Description="Synthesis Network router process"
              DisplayName="Synthesis Service"
              ErrorControl="normal"
              LoadOrderGroup="NetworkProvider"
              Name="Synthesis"
              Start="auto"
              Type="ownProcess"
              Arguments='-useconffile "%ALLUSERSPROFILE%\\Synthesis\\synthesis.conf" -logto "%ALLUSERSPROFILE%\\Synthesis\\synthesis.log"'
              Vital="yes" />
          ...
          <Component Id="CtrlExecutable" Guid="a916b730-974d-42a1-b687-d9d504cbb86a">
            <File
              Id="Synthesisctl"
              Name="synthesisctl.exe"
              DiskId="1"
              Source="synthesisctl.exe"
              KeyPath="yes"/>
          </Component>
    ...
    <Feature Id="SynthesisFeature" Title="Synthesis" Level="1">
    ...
    <CustomAction
      ...
      Directory="SynthesisInstallFolder"
